...
import '../features/trainee_features/profile/data/repos/complete_profile_repo_impl.dart';

List<BlocProvider> getBlocProviders() {
  return [
    BlocProvider(create: (context) => TraineeProfileCubit()),
    ...
    BlocProvider(create: (context) => TrainerHomeBloc()),
    BlocProvider(create: (context) => MyProfileTrainerCubit()),
