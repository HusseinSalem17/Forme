      ...
      body: Stack(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const FilterType(type: "Category", categories: [
                    'All',
                    'GYM',
                    'YOGA',
                    'Swimming',
                 ...
                 // const ReviewsRadio(),
                  Text('Facilities',
                      style: TextStyles.textStyleSemiBold.copyWith(
                          color: AppColors.n900Black, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
                  const FilterType(type: "Facilities", categories: [
                    'All',
                    'Car Parking',
                    'Locker',
                    'Shower',
                  ...
                  SizedBox(height: 16.h),
                  const FilterType(
                      type: "Gender", categories: ['Both', 'Male', 'Female']),
          ...
          const Align(
            ...
            child: TwoButtonsContainer(
                firstButtonTitle: 'Book Now', secondButtonTitle: 'Apply'),
          ),
        ],
      ),
    );
