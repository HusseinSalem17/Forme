          ...
          SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('Category', style: TextStyles.textStyleSemiBold.copyWith(color: AppColors.n900PrimaryTextColor, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
                  const FilterType(type: "Category", categories: ['All', 'GYM', 'YOGA', 'Swimming', 'Running', 'Boxing']),
                  SizedBox(height: 16.h),
                  Text('Price Range', style: TextStyles.textStyleSemiBold.copyWith(color: AppColors.n900PrimaryTextColor, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
                  const SliderPriceRange(),
                  SizedBox(height: 16.h),
                  Text('Reviews', style: TextStyles.textStyleSemiBold.copyWith(color: AppColors.n900PrimaryTextColor, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
                  const ReviewsRadio(),
                  Text('Facilities', style: TextStyles.textStyleSemiBold.copyWith(color: AppColors.n900PrimaryTextColor, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
                  const FilterType(type: "Facilities", categories: ['All', 'Car Parking', 'Locker', 'Shower', 'Cafe', 'Wifi', 'Personal Trainer']),
                  SizedBox(height: 16.h),
                  Text('Trainer Gender', style: TextStyles.textStyleSemiBold.copyWith(color: AppColors.n900PrimaryTextColor, fontSize: 16.sp)),
                  SizedBox(height: 16.h),
