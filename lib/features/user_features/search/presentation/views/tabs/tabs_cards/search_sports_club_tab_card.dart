...
import 'package:forme_app/features/user_features/search/presentation/views/widgets/image_section.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      model.period,
                      style: TextStyles.cardTextStyle.copyWith(fontSize: 8.sp, fontWeight: FontWeight.w400, color: AppColors.n200BodyContentColor),
                    ),
                  ],
                )
              ],
